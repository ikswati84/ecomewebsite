      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="space-y-4">
          ...
          <p class="text-gray-400 text-sm leading-relaxed">
            Your one-stop destination for premium products, exceptional service, and seamless shopping experience.
          </p>
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-2">
            ...
            <li><router-link to="/careers" class="text-gray-400 hover:text-white transition-colors">Careers</router-link></li>
          </ul>
        </div>
        ...
        <div class="space-y-4">
          ...
          <form class="space-y-3">
            <div class="flex">
              ...
              <button
                type="submit"
                class="px-4 py-2 bg-primary-500 text-white rounded-r-lg hover:bg-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500"
              >
                Subscribe
              </button>
            </div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div class="flex items-center space-x-4">
            <div class="flex items-center space-x-2">
              ...
              <span class="text-sm text-gray-400">Secure Payment</span>
            </div>
            <div class="flex items-center space-x-2">
              <svg class="w-5 h-5 text-green-400" fill="currentColor" viewBox="0 0 20 20">
